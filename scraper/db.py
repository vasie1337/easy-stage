...
def save_internship(conn, data):
    ...
    """, (
        ...
        data.get("company", {}).get("site"),
        data.get("company", {}).get("logo"),
        data.get("apply", {}).get("option"),
        data.get("apply", {}).get("value"),
        data.get("location", {}).get("street"),
        data.get("location", {}).get("zip"),
        data.get("location", {}).get("city"),
        data.get("location", {}).get("province"),
        data.get("location", {}).get("country", "NL"),
        data.get("location", {}).get("coords", {}).get("lat"),
        data.get("location", {}).get("coords", {}).get("lon"),
        data.get("level"),
        data.get("sublevel"),
